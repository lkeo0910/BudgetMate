...
export const fallbackProjects = [
  ...
  {
    id: 4,
    title: "Account Security & Automation",
    subtitle: "Trusted account tools",
    description:
      "Security checks, account summaries, and helpful automation to keep your finances organized.",
    accent: "#8b5cf6",
    link_url: "http://54.179.178.52/security",
    link_label: "Open tools",
    stats: [
...
export const fallbackSkills = [
  ...
  { id: 4, name: "Automation", category: "Automation", level: 82, description: "Trend detection, savings progress, and spending suggestions." },
...
export const fallbackLeadership = [
  ...
  },
  {
    ...
    organization: "BudgetMate",
    period: "2026",
    description: "Guides users through transaction review, trend analysis, and custom budget creation.",
    impact: ["Real-time data", "Clear workflows", "Trend explanations"]
  }
];
